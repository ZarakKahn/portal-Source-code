<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Training_Solution.Dashboard" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: 'Dashboard.aspx/GetData_Least',
                data: '{}',
                success:
                function (response) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: 'Dashboard.aspx/GetBarData_City',
                data: '{}',
                success:
                function (response) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: 'Dashboard.aspx/Get_Complaints',
                data: '{}',
                success:
                function (response) {
        ...
        function drawbar(dataValues) {
            ...
            draw(data, { width: 500, height: 250, min: 0, title: 'Top Visitors' });
        }
        function drawbar_least(dataValues) {
            ...
            draw(data, { width: 500, height: 250, min: 0, title: 'Least Visitors' });
        }
        ...
        <section class="section-title">
            ...
            <div class="container">
                ...
                <div class="text-center">
                    <h3 style="margin-top: 30px; color: darkred">SALES VISITS DASHBOARD</h3>
                    ...
                    <div class="box box-warning collapsed-box">
                        ...
                        <div class="row" style="padding: 5px">
                            ...
                            <div class="col-md-2" runat="server" id="team" >
                                <div class="form-group">
                                    <label>Team</label>
                                    <asp:DropDownList runat="server" class="form-control" ID="DropDownList_TMO" Visible="true">
                                    </asp:DropDownList>
                                </div>
                            </div>
                   ...
                   --%>
                                 ...
                                 <div class="col-xs-4 bg-green"  style="margin-top: 30px;width:12%;margin-left:5px" runat="server" id="Div3">
                                                <div class="description-block border-right  ">
                                                    ...
                                                    <span class="description-text text-bold" runat="server" id="recovery">123455</span>
                                                </div>
                                                <!-- /.description-block -->
                                            </div>
                                 <div class="col-xs-4 bg-navy"  style="margin-top: 30px;width:13%;margin-left:5px" runat="server" id="Div4">
                                                <div class="description-block border-right  ">
                                                    ...
                                                    <span class="description-text text-bold" runat="server" id="sales">123445</span>
                                                </div>
                                                <!-- /.description-block -->
                                            </div>
                                 <div class="col-xs-4 bg-green"  style="margin-top: 30px;width:13%;margin-left:5px" runat="server" id="Div5">
                                                <div class="description-block border-right  ">
                                                    ...
                                                    <span class="description-text text-bold" runat="server" id="exis_shops">455</span>
                                                </div>
                                                <!-- /.description-block -->
                                            </div>
                                 <div class="col-xs-4 bg-navy"  style="margin-top: 30px;width:13%;margin-left:5px" runat="server" id="Div6">
                                                <div class="description-block border-right  ">
                                                    ...
                                                    <span class="description-text text-bold" runat="server" id="new_shops">123</span>
                                                </div>
                                                <!-- /.description-block -->
                                            </div>
